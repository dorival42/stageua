...
nlle_table <- new_db_chlordecone[, c("COMMU_LAB", "mnt.exposition_mean", "mnt.ombrage_mean","surface.parcelle_m2","Date_analyse","Taux_chlordecone")] 
...
```{r}
# Convertir la colonne string en type numérique
#new_db_chlordecone$Taux_chlordecone <- as.numeric(new_db_chlordecone$Taux_chlordecone)

nb_na <- sum(is.na(new_db_chlordecone$Taux_chlordecone))
nb_na 
```
